...
{
    public abstract class TacoChallengeWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TacoChallengeWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TacoChallengeWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TacoChallengeDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TacoChallengeDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TacoChallengeDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TacoChallengeDbContext, Task<T>> func)
        {
            T result;
