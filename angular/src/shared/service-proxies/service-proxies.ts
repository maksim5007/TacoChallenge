...
export class SearchServiceProxy {
     ...
     * @return Success
     */
    search(searchText: string | null | undefined): Observable<SearchResultDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Search/Search?";
    ...
    protected processSearch(response: HttpResponseBase): Observable<SearchResultDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    createOrder(body: MenuItemDto[] | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Search/CreateOrder";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    runFtsIndexing(): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Search/RunFtsIndexing";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processRunFtsIndexing(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processRunFtsIndexing(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processRunFtsIndexing(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class CategoryGroupDto implements ICategoryGroupDto {
    name: string | undefined;
    menuItems: MenuItemDto[] | undefined;
    id: number;

    constructor(data?: ICategoryGroupDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CategoryGroupDto {
        data = typeof data === 'object' ? data : {};
        let result = new CategoryGroupDto();
        result.init(data);
        return result;
    }
...
export class SearchResultDto implements ISearchResultDto {
    ...
    categoryGroups: CategoryGroupDto[] | undefined;
    menuItems: MenuItemDto[] | undefined;
    id: number;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["categoryGroups"])) {
                this.categoryGroups = [] as any;
                for (let item of _data["categoryGroups"])
                    this.categoryGroups.push(CategoryGroupDto.fromJS(item));
            }
            if (Array.isArray(_data["menuItems"])) {
                this.menuItems = [] as any;
                for (let item of _data["menuItems"])
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.categoryGroups)) {
            data["categoryGroups"] = [];
            for (let item of this.categoryGroups)
                data["categoryGroups"].push(item.toJSON());
        }
        if (Array.isArray(this.menuItems)) {
            data["menuItems"] = [];
            for (let item of this.menuItems)
